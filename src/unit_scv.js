...
var scv = {
    beforeAge: function(){
        ...
        spawner.addToQueue("scv", {role:"scv", task: creep.memory.task, mode: creep.memory.mode, constructRoomName: creep.memory.constructRoomName, harvestRoomName: creep.memory.harvestRoomName}, creep.memory.spawnRoom, true)
    },
    behavior: function(){
        var creep = this.creep;
